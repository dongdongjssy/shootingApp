...
export default class MessageList extends Component {
  ...
  constructor(props) {
    ...
    this._onAvatarLongClick = this._onAvatarLongClick.bind(this);
  ...
  _onAvatarLongClick(event: Event) {
    if (!this.props.onAvatarLongClick) {
      return;
    }
    this.props.onAvatarLongClick(JSON.parse(event.nativeEvent.message));
  }
  ...
  render() {
    return (
      <RCTMessageList 
          ...
          onAvatarLongClick={this._onAvatarLongClick}
...
MessageList.propTypes = {
  ...
  onAvatarLongClick: PropTypes.func,
