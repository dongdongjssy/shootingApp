...
open class RCTMessageModel: IMUIMessageModel {
  ...
  static let kMsgAtMe = "atMe"
  static let kMsgAtAll = "atAll"
  static let kMsgSelfName = "selfName"
  static let kMsgSelfNikeName = "selfNikeName"
  ...
  @objc override open var resizableBubbleImage: UIImage {
    ...
    @objc public init(msgId: String, messageStatus: IMUIMessageStatus, fromUser: RCTUser, isOutGoing: Bool, time: String, type: String, text: String, mediaPath: String, imageUrl: String, layout: IMUIMessageCellLayoutProtocol, duration: CGFloat, extras: NSDictionary?,atMe : Bool,atAll : Bool,selfName : String,selfNikeName : String) {
    
    self.myTextMessage = text
    self.mediaPath = mediaPath
    self.extras = extras
    self.imageUrl = imageUrl
    super.init(msgId: msgId, messageStatus: messageStatus, fromUser: fromUser, isOutGoing: isOutGoing, time: time, type: type, cellLayout: layout, duration: duration,atMe: atMe,atAll: atAll,selfName: selfName,selfNikeName: selfNikeName)
  }
  ...
  @objc public convenience init(messageDic: NSDictionary) {
    ...
    let atAll = messageDic.object(forKey: RCTMessageModel.kMsgAtAll) as? Bool
    let atMe = messageDic.object(forKey: RCTMessageModel.kMsgAtMe) as? Bool
    let selfName = messageDic.object(forKey: RCTMessageModel.kMsgSelfName) as? String
    let selfNikeName = messageDic.object(forKey: RCTMessageModel.kMsgSelfNikeName) as? String
    ...
    self.init(msgId: msgId, messageStatus: msgStatus, fromUser: user, isOutGoing: isOutgoing ?? true, time: timeString!, type: msgType!, text: text!, mediaPath: mediaPath!,imageUrl: imgUrl, layout:  messageLayout!,duration: durationTime, extras: extras,atMe : atMe ?? false,atAll : atAll ?? false,selfName : selfName!,selfNikeName: selfNikeName!)
