...
public class MsgListAdapter<MESSAGE extends IMessage> extends RecyclerView.Adapter<ViewHolder>
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (wrapper.item instanceof IMessage) {
            ...
            ((BaseMessageViewHolder) holder).mAvatarLongClickListener = this.mAvatarLongClickListener;
    ...
    public void setOnAvatarLongClickListener(OnAvatarLongClickListener<MESSAGE> listener) {
        mAvatarLongClickListener = listener;
    }
