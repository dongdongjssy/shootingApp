...
public class AuroraIMUIModule extends ReactContextBaseJavaModule {
    ...
    private RCTMessage configMessage(ReadableMap message) {
        ...
        RCTMessage rctMsg = new RCTMessage(message.getString(RCTMessage.MSG_ID),
                ...
                message.getBoolean(RCTMessage.IS_OUTGOING),message.getString(RCTMessage.SELF_NAME),message.getBoolean(RCTMessage.AT_ME),message.getBoolean(RCTMessage.AT_ALL),message.getString(RCTMessage.SELF_NIKE_NAME));
