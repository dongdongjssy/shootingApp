...
public class ReactMsgListManager extends ViewGroupManager<PullToRefreshLayout> implements SensorEventListener {
    ...
    private static final String ON_AVATAR_LONG_CLICK_EVENT = "onAvatarLongClick";
    ...
    protected PullToRefreshLayout createViewInstance(final ThemedReactContext reactContext) {
        ...
        mAdapter.setOnAvatarLongClickListener(new MsgListAdapter.OnAvatarLongClickListener<RCTMessage>() {
            @Override
            public void onAvatarLongClick(RCTMessage message) {
                WritableMap event = Arguments.createMap();
                event.putString("message", message.toString());
                reactContext.getJSModule(RCTEventEmitter.class).receiveEvent(rootView.getId(), ON_AVATAR_LONG_CLICK_EVENT, event);
            }
        });
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.<String, Object>builder()
                ...
                .put(ON_AVATAR_LONG_CLICK_EVENT, MapBuilder.of("registrationName", ON_AVATAR_LONG_CLICK_EVENT))
