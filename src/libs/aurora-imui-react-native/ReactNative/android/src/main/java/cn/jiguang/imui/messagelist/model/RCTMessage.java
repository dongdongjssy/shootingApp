...
public class RCTMessage implements IMessage {
    ...
    public static final String SELF_NIKE_NAME = "selfNikeName";

    private String msgId;
    private String status;
    private String msgType;
    private String selfName;
    private String selfNikeName;
    ...
    public RCTMessage(String msgId, String status, String msgType, boolean isOutgoing,String selfName,boolean atMe,boolean atAll,String selfNikeName) {
        this.msgId = msgId;
        this.status = status;
        ...
        this.atAll = atAll;
        this.atMe = atMe;
        this.selfNikeName = selfNikeName;
    }
    ...
    @Override
    public String getSelfNikeName() {
        return this.selfNikeName;
    }
    ...
    public JsonElement toJSON() {
        ...
        json.addProperty(AT_ALL, atAll);
        json.addProperty(AT_ME, atMe);
        if (timeString != null) {
        ...
        if (selfName != null){
            json.addProperty(SELF_NAME,selfName);
        }

        if (selfNikeName != null){
            json.addProperty(SELF_NIKE_NAME,selfNikeName);
        }
