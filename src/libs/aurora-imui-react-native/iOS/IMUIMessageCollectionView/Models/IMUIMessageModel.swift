...
open class IMUIMessageModel: NSObject, IMUIMessageModelProtocol {
  ...
  open var time: String
    ...
    open var atMe : Bool = false
    open var atAll : Bool = false
    open var selfName : String
    open var selfNikeName : String
  ...
  open func webImageUrl() -> String {
    ...
    public init(msgId: String, messageStatus: IMUIMessageStatus, fromUser: IMUIUserProtocol, isOutGoing: Bool, time: String, type: String, cellLayout: IMUIMessageCellLayoutProtocol, duration: CGFloat?,atMe : Bool,atAll : Bool,selfName : String,selfNikeName : String) {
    self.msgId = msgId
    ...
    self.selfNikeName = selfNikeName
